...
<H2WithHash id="details-panel-targetting">右側の詳細パネルの部分置換をする</H2WithHash>
...
<H2WithHash id="comparison-with-react">Reactコードとの比較</H2WithHash>
...
Turboだけだったら追加のJavaScriptを一切書かなくても良かったのが、UXを改善しようと思うとやはり書く必要があるわけです。Turboだと変に甘えてしまって、このちょっとした改善を怠ることがありがちです。「Turboで楽をさせてもらった分はUXを頑張ろう！」ぐらいの気持ちでいた方が良いと思います。Turboを使ってもUXを良くするJavaScriptは書くつもりでいるべきだと思います。
