      ...
      <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        ...
        <div className="mt-10 max-w-2xl mx-auto">
          <p>
            ...
            Developers（フロントエンドエンジニアのためのHotwire入門）」は、すべてのウェブ開発者がHotwireを学べるように作成したサイトです
          </p>
          <p className="mt-2">
            なお本サイトは教材サイトではありません。よってチュートリアル等はありません。<br/>
          ...
          <ul role="list" className="mt-8 max-w-xl space-y-8 text-gray-600">
            <li className="flex gap-x-3">
              ...
              <span>
                ...
                HotwireはRuby on Railsに限らず、Django, Laravel, Java, Node, Wordpressなど、あらゆるバックエンド技術で使えます。本サイトはHotwireはすべてNext.jsの<a
            ...
            <li className="flex gap-x-3">
              ...
              <span>
                ...
                HotwireはサイトのUXを大幅に向上させます。体感レスポンスタイムの大幅短縮、画面の部分更新など、モダンフロントエンドのUX要件はHotwireだけでカバーできます。
              </span>
            </li>
            <li className="flex gap-x-3">
              <CheckCircleIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600"/>
              <span>
                ...
                Hotwireは古典的なHTML生成をベースに、これを拡張するアプローチです。ReactやNext.jsのような複雑さがありませんので、学習時間と工数を削減できます。
              </span>
            </li>
          </ul>
                ...
                <ul>
                  ...
                  <li className="flex gap-x-3">
                    ...
                    <span>
                      ...
                      className="text-indigo-600 hover:text-indigo-400 underline">Server-side Rendering</a>を使っています。まだこっちの方が現場では多いと感じているからです。エラーハンドリング等は省略しています。
                    </span>
                  </li>
                  <li className="flex gap-x-3">
                    <CheckCircleIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-gray-400"/>
                    <span>内容が頻繁に更新されるウェブアプリを想定し、古いデータが表示されたままになってしまうタイプのキャッシュは使用しないようにしていません。例えば<a href="https://nextjs.org/docs/app/building-your-application/caching#router-cache" className="text-indigo-600 hover:text-indigo-400 underline">Router Cache</a>はオフにしています。
                    </span>
                  </li>
                </ul>
              </span>
